...
{
    public partial class consult_clientes : Form
    {
        public consult_clientes()
        {
            InitializeComponent();
        }
        ...
        private void buscar_Click(object sender, EventArgs e)
        {
            if (nombre.Checked)
            {
                ...
                {
                    MessageBox.Show("NO HAY CLIENTES PARA CONSULTAR");
                }
        ...
        private void consult_clientes_Load(object sender, EventArgs e)
        {
            DataSet ds = new DataSet();
            string cmd = "select * from cliente";
            ds = utilidades.UTILIDADES.ejecutar(cmd);
