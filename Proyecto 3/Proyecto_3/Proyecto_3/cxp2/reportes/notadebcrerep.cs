...
{
    public partial class notadebcrerep : MetroForm
    {
        public notadebcrerep()
        {
            InitializeComponent();
        }
        ...
        private void notadebcrerep_Load(object sender, EventArgs e)
        {
        ...
        private void fechaf_VisibleChanged(object sender, EventArgs e)
        {
            fechaf1 = true;
        }
        ...
        private void salvar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                cxp2.reportes.tres frm = new cxp2.reportes.tres(datos);
                frm.Show();
            }
        }
